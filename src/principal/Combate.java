...
public class Combate {
	...
	public void comenzar() {
		...
		while (numKojugador < 6 && numKorival < 6) {
			...
			System.out.println("Jugador: " + jugador.getNombre() + " envía a " + pokemonJugador.getNombre() + " (Nivel "
					+ pokemonJugador.getNivel() + ")");
			System.out.println("Rival: " + rival.getNombre() + " envía a " + pokemonRival.getNombre() + " (Nivel "
